...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      private updateHoverState(clientX: number, clientY: number) {
        if (this.disabled) { this.isHoverInside = false; return false; }
  ...
  gl_FragColor = vec4(newv, 0.0, 0.0);
    ...
    class ExternalForce extends ShaderPass {
      ...
      initForce(simProps: Record<string, unknown>) {
        super.init();
    ...
    class Viscous extends ShaderPass {
      ...
      update(args: { viscous?: number; iterations?: number; dt?: number } = {}) {
        ...
        return this.props.output as THREE.WebGLRenderTarget;
      }
    }
    ...
    class WebGLManager implements LiquidEtherWebGL {
      ...
      constructor(props: Record<string, unknown>) {
        ...
        if (props.disableMouseInteraction) {
          Mouse.disabled = true;
          this.lastUserInteraction = 0; // immediately "idle" so auto-demo starts at once
        }
    ...
    const applyOptions = () => {
      ...
      Object.assign(sim.options, {
        ...
        isViscous, viscous, iterations_viscous: iterationsViscous,
        iterations_poisson: iterationsPoisson, dt, BFECC, resolution, isBounce
      });
    ...
    takeoverDuration, autoResumeDelay, autoRampDuration, disableMouseInteraction
  ]);
